OpenBrary V1.0 - Copyright (C) 2012 - 2013 Daven Bigelow, PUBLIC DOMAIN as of 2018 and updated to VS2017
----------------------------------
To start OpenBrary 
----------------------------------
1.) Copy and paste OpenBrary folder onto the target computer
...
2.) If using Windows Vista or Windows 7+, right click OpenBrary.exe and click "Run as administrator"

3.) If further issues occur, file a GitHub issue
